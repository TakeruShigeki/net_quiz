        ...
        <form action="{{ $action }}" method="{{ $method }}">
          ...
          <div class="md:flex items-center mt-8">
            <div class="w-full flex flex-col">
              ...
              <input type="text" name="choice4" class="w-auto py-2  border border-gray-300 rounded-md"
                id="title">
            </div>
          </div>
          <div class="text-shadow1 font-semibold">
            ...
            <div class="text-3xl">
              @foreach ($quiz->choices as $key => $choice)
                <label for="answer" class="flex items-center space-x-4 m-8">
                  ...
                  <input class="w-auto py-2 border border-gray-300 rounded-md" type="text"
                    value="{{ $choice->choice }} " name="choice{{ $key + 1 }}">
